...
<head>
    ...
    <link rel="styleheet" href="https://jqueryvalidation.org/files/demo/site-demos.css">"
    <title>Sistema de Login Nixollazxs Systems</title>
    <style>
        #caixaCadastro,
        #caixaRecuperarSenha,
        #alerta {
        ...
        <section class="row mb-5">
            <div class="col-lg-4 offset-lg-4 bg-light rounded" id="caixaCadastro">
                ...
                <form action="#" class="p-2" id="formCadastro">
                    ...
                    <div class="form-group">
                        <input type="text" name="nomeUsuário" id="nomeUsuário" class="form-control" placeholder="Nome de Usuário" inlength="5" required>
                    </div>
